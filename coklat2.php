...
<h3>Diskon Chocolate Milkshake: </h3>
   <table>
    <tr><th width="70%">Produk</th><th width="10%">Quantity</th><th width="20%">Jumlah</th></tr>
     
    <?php foreach($_SESSION['cart'] as $row):?>
   <?php
      $jumlah = $_SESSION['price'][$row['productid']] * $post['qqn']; 
      $total += $jumlah;
     ?>
     
     <tr><td><?php echo $post['productid'];?></td><td><?php echo $post['qqn'];?></td><td><?php echo $jumlah; ?></td></tr>
    <?php endforeach;?>
...
<br>
   ...
   <button onclick="setTimeout(myFunction, 1000)" style="background-color: #40ba37;width: 20%; height: 40px; cursor: pointer;color: #ffffff";
