                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            <li><a href="index.php">Menu Makanan</a></li>
                                            <li><a href="about.php">Menu Minuman</a></li>
                                   ...
                                   <!-- <li><a href="#">Mega Menu</a>
                                    ...
                                    -->
                                    <li><a href="receipe-post.php">Galeri</a></li>
                                    <li><a href="receipe-post.php">Pembelian</a></li>
                                    <li><a href="receipe-post.php">About Us</a></li>
                                </ul>
