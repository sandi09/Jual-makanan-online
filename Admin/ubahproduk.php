  ...
  if (!empty($lokasifoto))
   {
  		...
  		$koneksi->query("UPDATE produk SET Name='$_POST[nama]',harga='$_POST[harga]',berat='$_POST[berat]',foto='$namafoto',Deskripsi='$_POST[deskripsi]' WHERE ID = '$_GET[id]'");
  	}else{
  		$koneksi->query("UPDATE produk SET Name='$_POST[nama]',harga='$_POST[harga]',berat='$_POST[berat]',Deskripsi='$_POST[deskripsi]' WHERE ID = '$_GET[id]'");
  	}
