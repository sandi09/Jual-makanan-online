...
<link rel="stylesheet" href="style.css">
 ...
 <!-- Preloader -->
  ...
  <div id="wrapshopcart">
   ...
   <form action="coklat2.php" method="POST" onsubmit="validasi()">
...
<a href="menu-minuman.php" ><input type="" name="menumakan" class="btn btn-success" value="Beli Minuman"></a>
 ...
 <br>
 <label></label><h6>Chocolate Milkshake & Quantity</h6>
  <select name="productid"  ><option>Chocolate Milkshake <?php $_SESSION['cart'] = array(
